...
export default function ExpenseItem({ item, onEdit, onDelete }) {
  ...
  const isRecurring = !!item.recurringId || item.isFromRecurring;
      ...
      <>
          ...
          <div className="expense-cell expense-cell-title">
            ...
            <div>
              <div className="expense-title">
                {item.title}
                {isRecurring && (
                    <span className="expense-recurring-badge" title="Auto-generated from recurring">
                  🔄
                </span>
                )}
              </div>
              ...
              <div className="expense-payment-badge" style={{ color: payment.color }}>
        ...
        <div className="expense-card expense-card-mobile">
            ...
            <div className="expense-card-left">
              ...
              <div>
                <div className="expense-title">
                  {item.title}
                  {isRecurring && (
                      <span className="expense-recurring-badge" title="Auto-generated">
                    🔄
                  </span>
                  )}
                </div>
          ...
          <div className="expense-card-actions">
            <button className="btn-inline" onClick={onEdit}>
              <IconEdit /> Edit
            </button>
            <button className="btn-inline btn-inline-danger" onClick={onDelete}>
              <IconTrash /> Delete
            </button>
          </div>
        </div>
